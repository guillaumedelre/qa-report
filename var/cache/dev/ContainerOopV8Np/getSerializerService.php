...
include_once $this->targetDirs[3].'/src/Serializer/BehatStepNormalizer.php';
include_once $this->targetDirs[3].'/src/Serializer/CloverFileNormalizer.php';
include_once $this->targetDirs[3].'/src/Serializer/Crap4jFileNormalizer.php';
include_once $this->targetDirs[3].'/vendor/symfony/serializer/Normalizer/DenormalizerAwareInterface.php';
include_once $this->targetDirs[3].'/vendor/symfony/serializer/Normalizer/DenormalizerAwareTrait.php';
include_once $this->targetDirs[3].'/src/Serializer/CucumberJsonFileNormalizer.php';
include_once $this->targetDirs[3].'/src/Serializer/JUnitFileNormalizer.php';
include_once $this->targetDirs[3].'/src/Serializer/PhpmetricLogFileNormalizer.php';
...
$a = ($this->privates['serializer.encoder.xml'] ?? ($this->privates['serializer.encoder.xml'] = new \Symfony\Component\Serializer\Encoder\XmlEncoder()));
$b = ($this->privates['serializer.mapping.class_metadata_factory'] ?? $this->load('getSerializer_Mapping_ClassMetadataFactoryService.php'));

return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Agilicode\QAT\Serializer\BehatStepNormalizer(), 1 => new \Agilicode\QAT\Serializer\CloverFileNormalizer(), 2 => new \Agilicode\QAT\Serializer\Crap4jFileNormalizer(), 3 => new \Agilicode\QAT\Serializer\CucumberJsonFileNormalizer(), 4 => new \Agilicode\QAT\Serializer\JUnitFileNormalizer($a), 5 => new \Agilicode\QAT\Serializer\PhpmetricLogFileNormalizer(), 6 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 7 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 8 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer(), 9 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 10 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(), 11 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 12 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($b, new \Symfony\Component\Serializer\NameConverter\MetadataAwareNameConverter($b), new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, new \Symfony\Component\Cache\Adapter\ArrayAdapter(0, false)), new \Symfony\Component\PropertyInfo\PropertyInfoExtractor(new RewindableGenerator(function () {
    ...
    yield 0 => ($this->privates['property_info.reflection_extractor'] ?? ($this->privates['property_info.reflection_extractor'] = new \Symfony\Component\PropertyInfo\Extractor\ReflectionExtractor()));
}, 1)), new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($b))], [0 => $a, 1 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder())), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder()]);
